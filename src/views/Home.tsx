    ...
    <main className="w-full bg-[var(--brand-black)] overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center pb-16 md:pb-14">
          ...
          <Link
            to={heroCtaUrl}
            className="mt-3 md:mt-3 inline-flex items-center gap-2 px-8 py-3 rounded-full border-2 border-[var(--brand-yellow)] text-[var(--brand-yellow)] font-bebas text-2xl tracking-widest hover:bg-[var(--brand-yellow)] hover:text-black transition-colors group hero-cta-glow"
          >
